...
Documentation for SwiftUI components included in SwiftUIBase.
...
A custom navigation bar with `leading`, `center`, and `trailing` slots.
...
Utility extension to hide the native navigation bar safely across iOS versions.
